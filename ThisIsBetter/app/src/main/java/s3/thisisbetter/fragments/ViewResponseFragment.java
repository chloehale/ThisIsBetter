...
public class ViewResponseFragment extends Fragment {
     ...
     * number.
     */
    public static ViewResponseFragment newInstance(int sectionNumber, TimeBlock timeBlock) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayAdapter<String> adapter = new ViewResponseArrayAdapter(rootView.getContext(), timeBlock.generateTimesArray(), timeBlock);
